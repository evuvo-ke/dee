...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('loan::general.loan_provisioning',1) }}  </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.loan_provisioning',1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                ...
                @can('loan.loans.loan_provisioning.create')
                    <a href="{{ url('loan/loan_provisioning/create') }}" class="btn btn-info btn-sm">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('loan/loan_provisioning')}}">
            ...
            <div class="card-body p-0">
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <th>{{ trans_choice('loan::general.percentage',1) }}</th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('loan.loans.loan_provisioning.edit')
                                            <a href="{{url('loan/loan_provisioning/' . $key->id . '/edit')}}"
                                               class="dropdown-item">
                                        ...
                                        @can('loan.loans.loan_provisioning.destroy')
                                            <a href="{{url('loan/loan_provisioning/' . $key->id . '/destroy')}}"
