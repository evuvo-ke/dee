...
@section('title')
    {{ trans_choice('core::general.add',1) }} {{ trans_choice('savings::general.file',1) }}
@endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.add',1) }} {{ trans_choice('savings::general.file',1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('savings/'.$id.'/file/store') }}" enctype="multipart/form-data">
            {{csrf_field()}}
